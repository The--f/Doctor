...
<?php echo form_error('nom'); ?>
    <br /><input id="nom" type="text" name="nom" maxlength="20" value="<?php echo set_value('nom'); ?>"  />
</p>

<p>
    <label for="prenom">Prenom <span class="required">*</span></label>
<?php echo form_error('prenom'); ?>
    <br /><input id="prenom" type="text" name="prenom" maxlength="20" value="<?php echo set_value('prenom'); ?>"  />
</p>
